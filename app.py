...
@app.route('/chlamydia_gonorrhea')
def congenital_syphilis():
    return render_template('chlamydia_gonorrhea.html')
    ...
    if request.method=='POST' and 'unique_id' in request.form:
        ...
        with engine.connect() as con:
            ...
            con.execute(text(f"INSERT INTO hepatitis_b_mothers(created_by, created_at, updated_at, updated_by, unique_id)\
                                      VALUES('{created_by}','{created_at}', '{updated_at}', '{updated_by}','{unique_id}')"))
            con.execute(text(f"INSERT INTO chlamydia_gonorrhea_Clinic(created_by, created_at, updated_at, updated_by, unique_id)\
                                      VALUES('{created_by}','{created_at}', '{updated_at}', '{updated_by}','{unique_id}')"))
            con.execute(text(f"INSERT INTO chlamydia_gonorrhea_patient(created_by, created_at, updated_at, updated_by, unique_id)\
                                      VALUES('{created_by}','{created_at}', '{updated_at}', '{updated_by}','{unique_id}+patient')"))
