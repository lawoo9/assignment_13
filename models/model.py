...
class chlamydiagonorrhea(BaseModel, Base):
 __tablename__ = "chlamydia_gonorrhea_Clinic"
 id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
 created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now())
 updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now())
 created_by: Mapped[str] = mapped_column(String(200), ForeignKey("user.username", onupdate="CASCADE", ondelete="CASCADE"))
 ...
 person_completing_the_form: Mapped[str] = mapped_column(String(64), ForeignKey("client_profile.unique_id", onupdate="CASCADE", ondelete="CASCADE"))
 health_provider: Mapped[Optional[str]] = mapped_column(String(64))
 contact_phone_number: Mapped[Optional[str]] = mapped_column(String(64))

 class chlamydiagonorrheaPatient(BaseModel, Base):
  __tablename__ = "chlamydia_gonorrhea_Patient"
 id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
 created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now())
 updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now())
 created_by: Mapped[str] = mapped_column(String(200), ForeignKey("user.username", onupdate="CASCADE", ondelete="CASCADE"))
 ...
 gender: Mapped[str] = mapped_column(String(64), ForeignKey("chlamydia_gonorrhea_Clinic.patient_unique_id", onupdate="CASCADE", ondelete="CASCADE"))
 health_provider: Mapped[Optional[str]] = mapped_column(String(64))
 home_address: Mapped[Optional[str]] = mapped_column(String(64))
 contact_phone_number: Mapped[Optional[str]] = mapped_column(String(64))
 pregnancy_test_result: Mapped[Optional[str]] = mapped_column(String(64))
 ETHNICITY: Mapped[Optional[str]] = mapped_column(String(64))
 race: Mapped[Optional[str]] = mapped_column(String(64))
 gender_of_sex_partners: Mapped[Optional[str]] = mapped_column(String(64))
 test_result_type: Mapped[Optional[str]] = mapped_column(String(64))
 previous_hiv_testing: Mapped[Optional[str]] = mapped_column(String(64))
 reason_for_exam: Mapped[Optional[str]] = mapped_column(String(64))
 diagonsis: Mapped[Optional[str]] = mapped_column(String(64))
 sites: Mapped[Optional[str]] = mapped_column(String(64))
 GONORRHEA_TREATMENT_PLAN: Mapped[Optional[str]] = mapped_column(String(64))
 CHLAMYDIA_TREATMENT_PLAN: Mapped[Optional[str]] = mapped_column(String(64))
 PARTNER_MANAGEMENT_PLAN: Mapped[Optional[str]] = mapped_column(String(64))
